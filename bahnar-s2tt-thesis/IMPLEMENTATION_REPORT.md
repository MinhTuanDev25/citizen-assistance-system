...
- `notebooks/05_train_direct_s2tt.ipynb` — wire resume-safe Trainer for Phase B + full train
...
- Notebook AST requires `make_resume_safe_seq2seq_trainer_cls` wiring
